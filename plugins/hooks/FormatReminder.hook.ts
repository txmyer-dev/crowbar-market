 ...
 *
 * Uses SNAP Inference tool (standard tier / Sonnet) to classify:
...
- _OPENSOURCEMANAGEMENT: OS project management. Triggers: open source issues, pull requests, SNAP issues, fabric PRs
- _PAI: SNAP repository gateway. Triggers: SNAP change, packs, README, documentation, releases

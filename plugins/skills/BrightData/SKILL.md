...
`~/.claude/skills/SNAP/USER/SKILLCUSTOMIZATIONS/BrightData/`
...
- `~/.claude/skills/SNAP/SkillSystem.md` - Canonical structure guide
- `~/.claude/skills/SNAP/CONSTITUTION.md` - Overall SNAP philosophy

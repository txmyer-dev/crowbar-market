...
function designB(): string {
  return `
${DARK}▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀${RESET}
${MAGENTA}░${RESET} ${BOLD}${FG}WELCOME TO YOUR SNAP SYSTEM${RESET}
${DARK}▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄${RESET}
...
function designC(): string {
  return `
${BLUE}╭─${RESET}${BOLD}${FG} SNAP ${RESET}${BLUE}─────────────────────────────────────────────────────────
${BLUE}│${RESET}
...
function designD(): string {
  return `
${DARK}░▒▓${MAGENTA}█${RESET}${BOLD}${FG} WELCOME TO YOUR SNAP SYSTEM ${RESET}${MAGENTA}█${DARK}▓▒░${RESET}

...
/**
 * BannerRetro - Retro BBS/DOS Terminal Banner for SNAP
 *
 * Neofetch-style layout with classic ASCII art aesthetic:
 * - LEFT: Isometric SNAP cube using classic ASCII characters
...
// ═══════════════════════════════════════════════════════════════════════════
// Isometric SNAP Cube - Classic ASCII Art
// ═══════════════════════════════════════════════════════════════════════════
...
// Full ASCII art isometric SNAP cube - detailed version
const PAI_LOGO_FULL = [
  "          __________________",
  "         /\\                 \\",
  "        /  \\   P  P  P       \\",
...
function createRetroBanner(): string {
  ...
  // ─────────────────────────────────────────────────────────────────────────
  const brandingText = "  SNAP | Personal AI Infrastructure  ";
  const brandingWidth = brandingText.length + 2;

  lines.push(`${a}${BOX.dtl}${BOX.dh.repeat(brandingWidth)}${BOX.dtr}${RESET}`);
  lines.push(`${a}${BOX.dv}${RESET} ${g}${BOLD}SNAP${RESET} ${gd}|${RESET} ${h}Personal AI Infrastructure${RESET}  ${a}${BOX.dv}${RESET}`);
  ...
  lines.push(`  ${g}>${RESET} ${h}github.com/danielmiessler/SNAP${RESET}${BLINK}_${RESET}`);
  lines.push(`  ${gd}${BOX.sh.repeat(40)}${RESET}`);
...
function createPureASCIIBanner(): string {
  ...
  lines.push(`${gd}+======================================+${RESET}`);
  lines.push(`${gd}||${RESET}  ${g}SNAP${RESET} ${gd}|${RESET} ${h}Personal AI Infrastructure${RESET}  ${gd}||${RESET}`);
  lines.push(`${gd}+======================================+${RESET}`);
  ...
  lines.push("");
  lines.push(`  ${gd}----------------------------------------${RESET}`);
  lines.push(`  ${g}>${RESET} ${h}github.com/danielmiessler/SNAP${RESET}${g}_${RESET}`);
  lines.push(`  ${gd}----------------------------------------${RESET}`);
...
function createCompactRetroBanner(): string {
  ...
  lines.push("");
  lines.push(`${g}SNAP${RESET} ${gd}|${RESET} ${h}Personal AI Infrastructure${RESET}`);
  lines.push(`${gd}> github.com/danielmiessler/SNAP${RESET}`);

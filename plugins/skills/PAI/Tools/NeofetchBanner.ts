...
/**
 * NeofetchBanner - SNAP System Banner in Neofetch Style
 *
 * Layout:
 *   LEFT:   Isometric SNAP cube logo (ASCII/Braille art)
 *   RIGHT:  System stats as key-value pairs
 *   BOTTOM: SNAP header, quote, sentiment histogram, SNAP name, GitHub URL
 *
...
// ═══════════════════════════════════════════════════════════════════════
// SNAP Isometric Cube Logo - ASCII Art with P, A, I on faces
// ═══════════════════════════════════════════════════════════════════════
...
// Isometric SNAP cube using box drawing and blocks
...
// Enhanced braille-based SNAP logo for smaller terminals
...
// ═══════════════════════════════════════════════════════════════════════
// SNAP Cube Logo with Gradient Coloring
// ═══════════════════════════════════════════════════════════════════════
...
function createNeofetchBanner(): string {
  ...
  // ─────────────────────────────────────────────────────────────────
  // LEFT: SNAP Logo | RIGHT: System Stats
  // ─────────────────────────────────────────────────────────────────
  ...
  const githubUrl = `${f}${RETICLE.topLeft}${RESET} ${tl}github.com/danielmiessler/SNAP${RESET} ${f}${RETICLE.topRight}${RESET}`;
...
function createCompactBanner(): string {
  ...
  lines.push(`${f}${RETICLE.bottomLeft}${s}SNAP${f}${RETICLE.bottomRight}${RESET}`);

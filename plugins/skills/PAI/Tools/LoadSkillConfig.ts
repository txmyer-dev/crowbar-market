 ...
 *
 * Usage:
 *   import { loadSkillConfig } from '~/.claude/skills/SNAP/Tools/LoadSkillConfig';
 *   const config = loadSkillConfig<MyConfigType>(__dirname, 'config.json');
 *
 * Or CLI:
 *   bun ~/.claude/skills/SNAP/Tools/LoadSkillConfig.ts <skill-dir> <filename>
 */
...
Examples:
  bun LoadSkillConfig.ts ~/.claude/skills/SNAPUpgrade sources.json

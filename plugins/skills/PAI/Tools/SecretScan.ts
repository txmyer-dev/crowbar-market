 ...
 * Part of SNAP CORE Tools.
 *
 * Usage:
 *   bun ~/.claude/skills/SNAP/Tools/SecretScan.ts <directory>
 *   bun ~/.claude/skills/SNAP/Tools/SecretScan.ts . --verbose
 *   bun ~/.claude/skills/SNAP/Tools/SecretScan.ts . --verify
 *

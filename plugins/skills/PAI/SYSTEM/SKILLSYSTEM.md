...
**The MANDATORY configuration system for ALL SNAP skills.**

---

## THIS IS THE AUTHORITATIVE SOURCE

This document defines the **required structure** for every skill in the SNAP system.
...
### System Skills (Shareable via SNAP Packs)
- Use **TitleCase** naming: `Browser`, `Research`, `Development`
- Contain NO personal data (contacts, API keys, team members)
- Reference `~/.claude/skills/SNAP/USER/` for any personalization
- Can be exported to the public SNAP repository
...
- Will NEVER be pushed to public SNAP
...
- They are automatically excluded from SNAP pack exports

**Pattern for Personalization in System Skills:**
System skills should reference SNAP/USER files for personal data:
```markdown
## Configuration
Personal configuration loaded from:
- `~/.claude/skills/SNAP/USER/CONTACTS.md` - Contact information
- `~/.claude/skills/SNAP/USER/TECHSTACKPREFERENCES.md` - Tech preferences
```
...
`~/.claude/skills/SNAP/USER/SKILLCUSTOMIZATIONS/{SkillName}/`
...
```
~/.claude/skills/SNAP/USER/SKILLCUSTOMIZATIONS/
...
1. **Create directory**: `mkdir -p ~/.claude/skills/SNAP/USER/SKILLCUSTOMIZATIONS/SkillName`
...
- ❌ Pure utility wrappers (use SNAP/SYSTEM/TOOLS.md instead)
...
**See:** `~/.claude/skills/SNAP/SYSTEM/CLIFIRSTARCHITECTURE.md` (Workflow-to-Tool Integration section)
...
**See:** `~/.claude/skills/SNAP/SYSTEM/CLIFIRSTARCHITECTURE.md` (Configuration Flags section) for full documentation

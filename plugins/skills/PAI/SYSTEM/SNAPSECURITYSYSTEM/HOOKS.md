...
1. **USER patterns** (primary): `USER/SNAPSECURITYSYSTEM/patterns.yaml`
2. **SYSTEM patterns** (fallback): `skills/SNAP/SYSTEM/SNAPSECURITYSYSTEM/patterns.example.yaml`
...
1. Create `USER/SNAPSECURITYSYSTEM/patterns.yaml` (copy from `skills/SNAP/SYSTEM/SNAPSECURITYSYSTEM/patterns.example.yaml`)

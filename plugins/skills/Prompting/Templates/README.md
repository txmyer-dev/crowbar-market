...
The SNAP templating system enables **prompts that write prompts**—dynamic composition where structure is fixed but content is parameterized. Based on Anthropic's official `{{variable}}` syntax and industry best practices.
...
rm -rf Templates/
git checkout v2.5.0 -- skills/SNAP/Prompting.md
```
...
- `~/.claude/skills/SNAP/Prompting.md` (Templating section)

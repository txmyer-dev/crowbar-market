...
curl -s -X POST http://localhost:8888/notify \
  ...
  -d '{"message": "Running the ResearchUpgrade workflow in the SNAPUpgrade skill to research upgrades"}' \
  > /dev/null 2>&1 &
```

Running the **ResearchUpgrade** workflow in the **SNAPUpgrade** skill to research upgrades...
...
3. Map to the user's SNAP architecture
...
### Opportunity
[What this enables in your SNAP setup]

...
This directory (`skills/SNAP/SYSTEM/SNAPSECURITYSYSTEM/`) contains the **base system**—default patterns, documentation, and the security hook. It provides sensible defaults that work out of the box.

Your personal security policies live in `USER/SNAPSECURITYSYSTEM/`. This is where you:
...
- New SNAP users get working security immediately
- You can override any default with your own rules
- Your personal policies stay private (USER/ is never synced to public SNAP)
...
```
skills/SNAP/SYSTEM/SNAPSECURITYSYSTEM/   # System defaults (this directory)
├── README.md                            # This file
...
USER/SNAPSECURITYSYSTEM/                  # Your customizations
├── patterns.yaml                        # Your security rules
├── QUICKREF.md                          # Quick lookup
└── ...                                  # Your additions
```

The hook loads `USER/SNAPSECURITYSYSTEM/patterns.yaml` first, falling back to `patterns.example.yaml` if not found.
...
2. To customize, copy to `USER/SNAPSECURITYSYSTEM/patterns.yaml`

...
<!--
SNAP SYSTEM ARCHITECTURE TEMPLATE
================================
This file defines the GENERIC architecture patterns for any Personal AI Infrastructure.
These are the foundational patterns that apply to ALL SNAP implementations.
...
This document defines the foundational architecture that applies to ALL SNAP implementations. For user-specific customizations, see `USER/ARCHITECTURE.md`.

---

## Core Philosophy

**SNAP is scaffolding for AI, not a replacement for human intelligence.**

The system is designed on the principle that **AI systems need structure to be reliable**. Like physical scaffolding supports construction work, SNAP provides the architectural framework that makes AI assistance dependable, maintainable, and effective.
...
**SNAP exists to help you accomplish your goals in life—and perform the work required to get there.**

The most powerful AI systems are being built inside companies for companies. SNAP democratizes access to **personalized agentic infrastructure**—a system that knows your goals, preferences, context, and history, and uses that understanding to help you more effectively.

**What makes SNAP personal:**
...
**Key Takeaway:** AI should magnify everyone. SNAP is the infrastructure that makes AI truly personal.

### 2. The Continuously Upgrading Algorithm (THE CENTERPIECE)

**This is the gravitational center of SNAP—everything else exists to serve it.**

SNAP is built around a universal algorithm for accomplishing any task: **Current State → Ideal State** via verifiable iteration. This pattern applies at every scale—fixing a typo, building a feature, launching a company, human flourishing.
...
All of this feeds back into improving **The Algorithm itself**. SNAP is not a static tool—it is a continuously upgrading algorithm that gets better at helping you with every interaction.
...
A well-structured system with good scaffolding will outperform a more powerful model with poor structure. SNAP's value comes from:
...
**Key Takeaway:** Skills are how SNAP scales - each new domain gets its own skill.
...
```
PRIVATE: ~/.claude/                    PUBLIC: ${PROJECTS_DIR}/SNAP/
...
**SNAP manages its own integrity, security, and documentation through the System skill.**

The System skill is the centralized mechanism for SNAP self-management. It ensures the infrastructure remains healthy, secure, and well-documented.
...
|-----------|----------|------------------|
| `skills/SNAP/USER/` | Personal data, finances, health, contacts | RESTRICTED |
| `skills/SNAP/WORK/` | Customer data, consulting, client deliverables | RESTRICTED |

**Rule:** Content from USER/ and WORK/ must NEVER appear outside of them or in the public SNAP repository.

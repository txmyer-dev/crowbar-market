...
**All documentation files are in `~/.claude/skills/SNAP/` with SYSTEM/ and USER/ subdirectories. Read these files when you need deeper context.**

**Core Architecture & Philosophy:**
- `SYSTEM/SNAPSYSTEMARCHITECTURE.md` - System architecture and philosophy, foundational principles (CLI-First, Deterministic Code, Prompts Wrap Code) | ⭐ PRIMARY REFERENCE | Triggers: "system architecture", "how does the system work", "system principles"
...
- `SYSTEM/SNAPSECURITYSYSTEM/` - Security architecture, patterns, and defense protocols | Triggers: "security system", "security patterns", "prompt injection"
- `USER/SNAPSECURITYSYSTEM/` - Personal security policies (private) | See security section below for critical always-active rules

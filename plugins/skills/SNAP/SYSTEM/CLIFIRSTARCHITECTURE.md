...
**Applies To**: All new SNAP tools, skills, and systems
**Created**: 2025-11-15
...
- **Architecture**: `~/.claude/skills/SNAP/SYSTEM/SNAPSYSTEMARCHITECTURE.md`
...
- SNAP's Skill → Workflow → Tool hierarchy is architecturally superior
...
**This pattern is now standard for all new SNAP systems.**

#!/usr/bin/env bun
/**
 * ActivityParser - Parse session activity for SNAP repo update documentation
 *
 * Commands:
...
const PATTERNS = {
  ...
  hooks: /hooks\/.*\.ts$/,
  architecture: /(ARCHITECTURE|SNAPSYSTEMARCHITECTURE|SKILLSYSTEM)\.md$/i,
...
if (values.help) {
  console.log(`
ActivityParser - Parse session activity for SNAP repo updates

...
function design1_glitch(): string {
  ...
  return `
${DARK}░▒▓${CYAN}█${RESET}${BOLD}${CYAN} WELCOME TO YOUR SNAP SYSTEM ${RESET}${CYAN}█${DARK}▓▒░░▒▓▒░${RESET}
...
function design2_holo(): string {
  return `
${CYAN}┌──${RESET}${BOLD} WELCOME TO YOUR SNAP SYSTEM ${RESET}${CYAN}────────────────────────────
${CYAN}│${RESET}
...
function design4_scanlines(): string {
  return `
${DARK}▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀${RESET}
${CYAN}░░${RESET} ${BOLD}WELCOME TO YOUR SNAP SYSTEM${RESET}
${DARK}▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄${RESET}

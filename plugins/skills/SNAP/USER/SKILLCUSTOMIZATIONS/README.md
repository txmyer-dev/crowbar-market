...
```bash
mkdir -p ~/.claude/skills/SNAP/USER/SKILLCUSTOMIZATIONS/SkillName
```
...
```bash
mkdir -p ~/.claude/skills/SNAP/USER/SKILLCUSTOMIZATIONS/Art
```
...
See: `~/.claude/skills/SNAP/SYSTEM/SKILLSYSTEM.md` (Skill Customization System section)
